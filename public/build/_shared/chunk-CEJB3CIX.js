...
var LogoImage = ({ className }) => {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("svg", {
    width: 105,
    className: (0, import_classnames.default)(`w-[95px] sm:w-[105px]`, className),
    viewBox: "0 0 733 140",
    fill: "none",
...
var LogoImage_default = LogoImage;

export {
  LogoImage_default
};
//# sourceMappingURL=/build/_shared/chunk-CEJB3CIX.js.map
